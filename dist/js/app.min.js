...
console.log("Priority one"),console.log("Insure return of organism for analysis"),console.log("All other considerations secondary."),console.log("Crew expendable."),$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var o=$(this.hash);if(o=o.length?o:$("[name="+this.hash.slice(1)+"]"),o.length)return $("html, body").animate({scrollTop:o.offset().top},1e3),!1}})}),$(".gallery").flickity({contain:!0,wrapAround:!0,pageDots:!1,setGallerySize:!1,arrowShape:{x0:30,x1:60,y1:30,x2:60,y2:15,x3:45}});